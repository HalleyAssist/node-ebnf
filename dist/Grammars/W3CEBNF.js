...
(function (BNF) {
    ...
    function getSubItems(tmpRules, seq, parentName, optionIndex, caseInsensitive = false, subitemCounter) {
        let anterior = null;
        let bnfSeq = [];
    ...
    function createRule(tmpRules, token, name, caseInsensitive = false, subitemCounter) {
